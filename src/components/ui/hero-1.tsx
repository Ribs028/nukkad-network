...
export interface Hero1Props {
    ...
    className?: string;
    /** Background image URL (omit for a plain gradient background) */
    backgroundImage?: string;
    /** Background video URL (takes priority over backgroundImage when set) */
    backgroundVideo?: string;
    /** Background color (defaults to the ink token) */
        ...
        >
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background:
                            "radial-gradient(ellipse 90% 70% at 80% 100%, hsl(var(--primary) / 0.25), transparent 60%)",
                    }}
                />
            </motion.div>
